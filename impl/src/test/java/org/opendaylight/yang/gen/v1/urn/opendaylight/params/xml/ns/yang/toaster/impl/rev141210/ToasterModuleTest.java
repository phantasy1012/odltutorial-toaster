...
public class ToasterModuleTest {
    ...
    public void testCustomValidation() {
        ToasterModule module = new ToasterModule(mock(ModuleIdentifier.class), mock(DependencyResolver.class));
    ...
    public void testCreateInstance() throws Exception {
        ...
        ToasterModule module = new ToasterModule(mock(ModuleIdentifier.class), dependencyResolver);
